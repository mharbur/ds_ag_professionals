...
saveWidget(m, "temp.html", selfcontained = FALSE)
webshot("temp.html", file = "data-unit-12/images/leaflet_map10.png",
        cliprect = "viewport")
...
saveRDS(complete_soil_data, "data-unit-12/exercise_ssurgo.Rds")
```


```{r message=FALSE, warning=FALSE, include=FALSE}
complete_soil_data <- readRDS("data-unit-12/exercise_ssurgo.Rds")
```
